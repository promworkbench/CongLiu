...
public class VisualizeExtendedDFGGraphvizMethodView {
	...
	private static HashMap<XEventClass, DFGExtendedHierarchies> eventclass2dfg;
	private static Dot dot4subDfg; 
	
	@Plugin(name = "Visualize Lengthe-2 Nested DFG , New", returnLabels = { "Dot visualization" }, returnTypes = { JComponent.class }, parameterLabels = { "Process Tree" }, userAccessible = false)
	@Visualizer
	...
	public JComponent visualize(PluginContext context, DFGExtendedHierarchies dfgeh) {
		...
		eventclass2dfg = dfgeh.getXEventClass2DFGH();
