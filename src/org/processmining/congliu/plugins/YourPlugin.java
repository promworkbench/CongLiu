...
import org.processmining.congliu.algorithms.YourAlgorithm;
import org.processmining.congliu.connections.YourConnection;
import org.processmining.congliu.dialogs.DialogModel;
import org.processmining.congliu.dialogs.YourDialog;
import org.processmining.congliu.help.YourHelp;
import org.processmining.congliu.models.YourFirstInput;
import org.processmining.congliu.models.YourOutput;
import org.processmining.congliu.models.YourSecondInput;
import org.processmining.congliu.parameters.YourParameters;
...
public class YourPlugin extends YourAlgorithm {
	...
	public YourOutput testUI(UIPluginContext context) {
	    ...
	    YourParameters parameters = new YourParameters(input1, input2);
	    // Get a dialog for this parameters.
	    DialogModel dialog = new DialogModel(context);
	   // YourDialog dialog = new YourDialog(context, input1, input2, parameters);
	    // Show the dialog. User can now change the parameters.
	    InteractionResult result = context.showWizard("Your dialog title", true, true, dialog);
	    // User has close the dialog.
