 ...
 * (3) combine start & complete to one. with two nano-seconds start and complete
 * (4) XES logging on: https://svn.win.tue.nl/repos/prom/XPort/ are used.
 * @author cliu3
 *
 */
@Plugin(
		name = "Pre-processing XPort based Software Event Log (V1)",// plugin name
...
public class SoftwareLogRefactoringPluginV1 {
	@UITopiaVariant(
	        affiliation = "TU/e", 
	        author = "Cong liu", 
